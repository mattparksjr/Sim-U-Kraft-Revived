...
public class FolkModel extends EntityModel<EntityFolk> {
    // This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(SimUKraft.MODID, "entity_folk"), "main");
    ...
    @Override
    public void setupAnim(EntityFolk entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
